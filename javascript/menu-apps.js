...
const apps = [
  {
    name: 'Discord',
    image: '/uploads/covers/discord.png',
    path: '/4ppz/discord.html',
    clickCount: 0,
    isFavorited: false,
  },
  {
    name: 'YouTube',
    image: '/uploads/covers/youtube.png',
    path: '/4ppz/youtube.html',
    clickCount: 0,
    isFavorited: false,
  },
  {
    name: 'Instagram',
    image: '/uploads/covers/instagram.png',
    path: '/4ppz/instagram.html',
    clickCount: 0,
    isFavorited: false,
  },
  {
    name: 'Snapchat',
    image: '/uploads/covers/snapchat.png',
    path: '/4ppz/snapchat.html',
    clickCount: 0,
    isFavorited: false,
  },
  {
    name: 'Spotify',
    image: '/uploads/covers/spotify.png',
    path: '/4ppz/spotify.html',
    clickCount: 0,
    isFavorited: false,
  },
];
