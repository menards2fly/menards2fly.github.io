...
const shows = [
  {
    ...
    image: '/uploads/covers/phineasandferb.png',
    link: '/storage/tv/phineasandferb',
    clickCount: 0,
    isFavorited: false,
    path: '/watch',
  },
  {
    name: 'Gravity Falls',
    image: '/uploads/covers/gravityfalls.png',
    link: '/storage/tv/gravityfalls',
    clickCount: 0,
    isFavorited: false,
    path: '/watch',
  },
  {
    ...
    image: '/uploads/covers/theamazingworldofgumball.png',
    link: '/storage/tv/theamazingworldofgumball',
    clickCount: 0,
    isFavorited: false,
    path: '/watch',
  },
  {
    name: 'Bluey',
    image: '/uploads/covers/bluey.png',
    link: '/storage/tv/bluey',
    clickCount: 0,
    isFavorited: false,
    path: '/watch',
  },
